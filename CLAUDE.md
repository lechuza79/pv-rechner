...
**Sie geht NUR an bestätigte Adressen.** Von 17 fremden Konten haben 10 den Anmeldelink nie eingelöst; sie bekommen nichts. Im doppelten Bestätigungsverfahren ist die ausbleibende Bestätigung **definitionsgemäß ein Nein** — eine zweite Mail behandelt dieses Nein als Vielleicht. Dazu der Zeitablauf gegen die vernünftigen Erwartungen (ErwG 47) und das ohnehin fällige Löschgebot (Art. 17 Abs. 1 Buchst. a): Der Zweck der Speicherung ist mit dem Scheitern der Registrierung entfallen. Legal-Judge am 02.09.2026, Fundstellen im Volltext geprüft.
- **Der Einwand „die erste Mail lag im Spam" ist ernst und bleibt eine VERMUTUNG.** Die alten Mails gingen über den eingebauten Versand des Anmeldedienstes, dessen Zustellprotokolle nicht herausgegeben werden (am 02.09.2026 über die Schnittstelle geprüft, nicht erreichbar). **Ohne diesen Beleg wird gelöscht, nicht geschrieben** — mit Beleg wäre eine einmalige Nachricht vertretbar, aber nur als **Löschankündigung** mit getrenntem Widerspruchshinweis, nie als Einladung zurückzukommen.

**KEIN WORT MEHR, ALS DORT STEHT.** Die Nachricht ist keine Werbung, sondern Fortführung eines bestehenden Nutzungsverhältnisses (Art. 6 Abs. 1 Buchst. b). Genau diese Einordnung kippt mit jedem Beipack — der BGH hat eine im Kern zulässige Rechnungsmail allein wegen einer angehängten Zufriedenheitsbefragung als unzulässige Werbung eingestuft (VI ZR 225/17). Ein Hinweis auf das Themen-Abo, auf einen neuen Rechner, ein Marketing-Fuß oder ein Symbol eines sozialen Netzes machen aus der erlaubten Systemmail eine Werbemail an Adressen ohne Werbeeinwilligung. Ein Test prüft das am fertigen HTML und hat seine eigene Gegenprobe.

**Kein Abmeldelink und keine Mailinglisten-Kopfzeile** — anders als beim Gemeinde-Abo, und aus demselben Denken heraus: Es gibt keinen Verteiler. Ein Link, der nichts abmeldet, ist eine unwahre Angabe, und das Banner der Mailprogramme ordnete die Nachricht falsch ein.

**Der Knopf führt auf die Anmeldeseite, nicht auf einen fertigen Anmeldelink.** Die Mail transportiert dann keinen gültigen Kontozugang, der im Postfach liegen bleibt — und sie sieht dem Phishing weniger ähnlich, dessen Muster sie sonst punktgenau trägt („dein Konto", „setz dein Passwort", ein Link).
