...
**Browser-Smokes (Playwright)** laufen NICHT im Pre-commit (zu langsam, ~45 s), sondern in GitHub Actions bei jedem PR und Push auf `main`. Sechs End-to-End-Tests klicken die Hauptflows durch; bei Failure landet ein HTML-Report als Artifact.
