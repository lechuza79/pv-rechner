...
**Über jedem Flow steht `components/FlowSchritte.tsx`** (seit 21.09.2026): nummerierte Schritte mit Namen, erledigte abgehakt und zum Zurückspringen anklickbar, der Name des aktuellen Schritts IST die Schritt-Überschrift (sonst stand er doppelt da). Auf schmalen Bildschirmen nur Zahlen, der Name rückt darunter — mittig unter dem letzten von fünf Schritten liefe er über den Rand. Vorwärts springen geht nicht, das umginge die Freigabe des Weiter-Knopfes.
