...
- **Ein Häkchen „angemeldet bleiben" wäre die angenehmere Lösung und ist bewusst nicht gebaut.** Es heilt die Ausnahme nicht, es ersetzt sie durch eine Einwilligung nach § 25 Abs. 1 — mit Nachweis, Widerruf und Dokumentation. Diese Seite hat heute keine einzige Einwilligung; die erste dafür einzuführen, dass man einen Bookmark nicht neu anmelden muss, wäre der teurere Tausch. Wer es später will, baut es dort ein.
...
**Was noch fehlt und dem Betreiber gehört:** der eigene Absender für die Anmeldemails (Eintrag im Dashboard des Anmeldedienstes, Zugangsdaten des Domain-Postfachs) und die Einrichtung des Google-Anbieters. Bis beides steht, geht keine Mail von unserer Adresse und der Google-Knopf führt ins Leere. **Der tatsächlich gelieferte Datensatz von Google ist erst nach der Einrichtung messbar** — der Text der Erklärung ist bis dahin aus dem Quelltext des Dienstes abgeleitet, nicht gemessen.
