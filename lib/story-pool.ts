...
export const STORY_FACETS: Record<string, Facets> = {
  ...
  'Einspeisevergütung-Monatsrecap': {categories:['energy-model'],time:'retrospective'},
  'Stromwert-Monatsrecap': {categories:['energy-model'],time:'retrospective'},
  'Zubau-Monatsrecap': {categories:['g2'],time:'retrospective'},
