...
/** Singular oder Plural — Grammatik ist Teil der Richtigkeit: „1 neue
 * Solaranlagen" stand in 3.770 der 11.252 Ortspakete (gemessen 22.09.2026). */
const mehrzahl=(count:number,eine:string,viele:string)=>`${n(count)} ${count===1?eine:viele}`;
