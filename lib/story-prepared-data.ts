...
export type PreparedStoryData={sourceDate:string;monthly?:SolarMonth;annual?:EnergyYear;values?:Record<string,PreparedValue>;availability:{topic:string;status:'ready'|'missing';reason:string}[];preparedAt:string};
