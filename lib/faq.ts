...
export function gasheizungWaermepumpeFaq(): FaqEntry[] {
  return [
    ...
    },
    {
      ...
      a: `Die Bio-Treppe (§ 43 GModG) gilt für Heizungen für Gas, Heizöl oder Flüssiggas, die nach dem Inkrafttreten des Gesetzes eingebaut werden — im Bestand wie im Neubau. Wer eine solche Heizung betreibt, muss ab 2029 einen steigenden Anteil klimafreundlicher Brennstoffe beimischen. Das Gesetz nennt vier Stufen: ${bioTreppeStufenText("Prozent")}. Eine 100-Prozent-Stufe steht dort nicht; dass Heizungsbrennstoffe ab 2045 vollständig klimaneutral sein sollen, folgt aus einer eigenen Ankündigung des Gesetzes (§ 42a GModG), für die ein gesondertes Quotengesetz erst noch kommen muss. Anrechenbar sind neben Biomethan auch Bioheizöl, biogenes Flüssiggas sowie Wasserstoff und daraus hergestellte Derivate. Biomethan kostet rund doppelt so viel wie Erdgas, deshalb steigt der Gaspreis deutlich stärker als durch die normale Teuerung.`,
    },
    {
      q: "Gilt die Grüngas-Pflicht auch im Neubau?",
      a: `Ja. Der Paragraf zur Beimischpflicht steht zwar im Kapitel über bestehende Gebäude und spricht dort vom Heizungstausch — für neu errichtete Gebäude verweist das Gesetz aber ausdrücklich auf dieselben Vorgaben (§ 10 Absatz 2 Nummer 3 GModG: „die Maßgaben der §§ 42 bis 45 entsprechend"). Die amtliche Begründung sagt es wörtlich: Diese Maßgaben seien „für neu zu errichtende Gebäude nach § 10 Absatz 2 Nummer 3 einzuhalten". Wer heute neu baut und sich für Gas, Heizöl oder Flüssiggas entscheidet, hat also dieselbe Treppe vor sich. Für den Neubau kommt zweierlei hinzu: Ab dem ${GMODG_RECHTSSTAND.neubauReferenzAb} wird der Effizienznachweis gegen ein neues Vergleichsgebäude geführt, dessen Kennwert eine reine Erdgasheizung überschreitet — sie müsste an anderer Stelle ausgeglichen werden. Und ab dem ${GMODG_RECHTSSTAND.neubauNullemissionAb} muss jeder Neubau ein Nullemissionsgebäude sein und darf am Standort keine CO₂-Emissionen aus fossilen Brennstoffen mehr verursachen.`,
    },
    {
