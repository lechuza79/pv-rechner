...
describe("Leere Liste, fehlendes Feld — zwei verschiedene Fragen", () => {
  ...
  it("keeps unverified combinations explicit and out of the federal grant stack", () => {
    ...
    expect(unknown.map(p => p.id).sort()).toEqual(["altenkirchen-balkonkraftwerke", "altenkirchen-solarspeicher", "asbach-baeumenheim-foerderprogramm", "bad-marienberg-erneuerbare-energien", "bruehl-baden-umweltschutz", "bubenreuth-co2-einsparung", "burbach-klimaschutz-privat", "cochem-zell-solarstromspeicher", "delmenhorst-balkon-solar", "ehningen-steckerfertige-pv", "ekm-altenkirchen", "eppelheim-balkonkraftwerke", "floersheim-photovoltaik", "florstadt-photovoltaik", "fritzlar-balkonkraftwerke-speicher", "gaildorf-balkonkraftwerke", "havelland-stecker-solar", "holzminden-solarfair", "kaufungen-sondervermoegen", "kirchlengern-pv-kleinanlagen", "leverkusen-photovoltaik", "mauer-balkonkraftwerke", "mutterstadt-balkonkraftwerke", "pfaffenhofen-balkon", "radolfzell-sonnige-zukunft", "rheinisch-bergisch-balkonsolar", "schaumburg-solarfair", "schwarzenfeld-balkon-pv", "sh-balkon-klimaschutz-bub", "sh-speicher-klimaschutz-bub", "sh-waermepumpe-klimaschutz-bub", "wendelstein-pv", "wendlingen-energie", "wertingen-photovoltaik"]);
