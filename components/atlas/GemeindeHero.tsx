...
const S: Record<string, React.CSSProperties> = {
  ...
  centerValue: { fontFamily: v("--font-mono"), fontSize: v("--font-size-display-sm"), fontWeight: 700, lineHeight: 1.1 },
  ...
  centerLabel: { fontSize: v("--font-size-caption"), color: v("--color-text-secondary"), marginTop: 4 },
  centerSub: { fontSize: v("--font-size-micro"), color: v("--color-text-muted"), fontFamily: v("--font-mono") },
  ...
  empty: { fontSize: v("--font-size-small"), color: v("--color-text-muted"), margin: 0 },
  ...
  rankHinweis: { fontSize: v("--font-size-caption"), color: v("--color-text-muted"), lineHeight: 1.4, margin: "2px 0 6px" },
  pickerArrow: {
    border: `1px solid ${v("--color-border")}`,
  ...
  peerRank: { fontFamily: v("--font-mono"), fontSize: v("--font-size-caption"), color: v("--color-text-muted") },
  krone: { marginRight: 4, fontSize: v("--font-size-caption") },
  ...
  peerVal: { fontFamily: v("--font-mono"), fontSize: v("--font-size-caption"), display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 3 },
