  ...
  return (
    <span style={{ display: "inline-flex", alignItems: "center", gap: Math.round(height * 0.22) }}>
      <svg width={iconW} height={height} viewBox="0 0 21.09 31" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ display: "block", flexShrink: 0 }}>
        <defs>
          <linearGradient id={gradId} x1="10.677" y1="19.269" x2="10.677" y2="6.119" gradientUnits="userSpaceOnUse">
        ...
        <g clipPath={`url(#${clipId})`}>
          ...
          <path opacity="0.4" d="M19.943 7.497 8.468 18.901a.369.369 0 0 1-.737-.003L1.408 12.508a.369.369 0 0 1 .003-.736L12.885.368a.369.369 0 0 1 .737.003l6.324 6.39a.369.369 0 0 1-.003.736Z" fill={`url(#${gradId})`} />
