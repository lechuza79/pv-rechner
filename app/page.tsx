    ...
    <div style={{ background: v('--color-bg'), fontFamily: v('--font-text'), color: v('--color-text-primary'), minHeight: "100vh", padding: "20px 16px" }}>
      <div style={{ maxWidth: v('--page-max-width'), margin: "0 auto" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 36, paddingTop: 20 }}>
          ...
          <h1 style={{ fontSize: 24, fontWeight: 800, letterSpacing: "-0.02em", color: v('--color-text-white'), lineHeight: 1.2 }}>Lohnt sich Photovoltaik?</h1>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12, marginBottom: 32 }}>
          <Link href="/empfehlung" style={{ textDecoration: "none" }}>
            <div style={{
              background: v('--color-bg-card'), borderRadius: v('--radius-card-lg'), padding: "20px", cursor: "pointer",
          ...
          <Link href="/rechner" style={{ textDecoration: "none" }}>
            <div style={{
              background: v('--color-bg-card'), borderRadius: v('--radius-card-lg'), padding: "20px", cursor: "pointer",
              border: `2px solid ${v('--color-border-input')}`,
            }}>
              <div style={{ fontSize: 16, fontWeight: 700, color: v('--color-text-primary'), marginBottom: 6 }}>
              ...
              <div style={{
                marginTop: 12, display: "inline-block", padding: "8px 16px", borderRadius: v('--radius-button'),
                fontSize: 13, fontWeight: 600, background: "transparent", color: v('--color-text-tertiary'),
