...
export const importFaqs: FaqItem[] = [
  ...
  },
  {
    ...
    long: `Eine "Dunkelflaute" ist ein Zeitraum, in dem gleichzeitig wenig Wind weht und wenig Sonne scheint, sodass Wind- und Solaranlagen kaum Strom liefern. Ein "Blackout" wäre ein großflächiger, unkontrollierter Ausfall der Stromversorgung im ganzen Netz — etwas anderes als eine kurze, örtliche Störung, wie sie zum Beispiel durch Bauarbeiten entstehen kann. Wie oft so etwas vorkommt, hängt ganz davon ab, wo man die Schwelle zieht — eine allgemein anerkannte Definition gibt es nicht. Legt man eine harte Schwelle an (mindestens zwei Tage am Stück unter einem Zehntel der Nennleistung), gab es 2025 vier solcher Phasen. Trotzdem war die Stromversorgung in Deutschland 2024 im Schnitt nur 11,7 Minuten im ganzen Jahr pro Haushalt unterbrochen (2023: 12,8 Minuten) — einer der niedrigsten Werte weltweit, deutlich besser als zum Beispiel in den USA (dort rund 130 Minuten, ebenfalls ohne Großereignisse gerechnet). Schwieriger wird es bei mehrtägigen Dunkelflauten: Dauert eine solche Phase eine Woche oder länger an, reichen die heutigen Batteriespeicher nicht aus, die eher für Stunden bis ein bis zwei Tage gebaut sind. Deshalb wird diskutiert, ob man dafür zusätzlich Gaskraftwerke braucht oder ein neues Bezahlmodell, bei dem Kraftwerke schon dafür Geld bekommen, dass sie im Ernstfall bereitstehen.`,
  },
];
