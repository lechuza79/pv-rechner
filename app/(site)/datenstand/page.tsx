  ...
  return (
    <div style={S.page}>
      <div style={S.wrap}>
        ...
        <p style={S.note}>
          Alle Werte sind Näherungen. Einen Teil davon kannst du im Ergebnis überschreiben,
          wenn er nicht zu deiner Situation passt. Wie aus diesen Werten die Rendite entsteht,
