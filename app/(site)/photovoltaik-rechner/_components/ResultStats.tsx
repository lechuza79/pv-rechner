    ...
    <>
      ...
      <div style={{ background: v('--color-bg'), borderRadius: v('--radius-md'), padding: "14px 16px", marginBottom: 10, border: `1px solid ${v('--color-border')}` }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
          ...
          <div>
            <div style={{ fontSize: v("--font-size-caption"), color: v('--color-text-secondary'), textTransform: "uppercase", letterSpacing: "0.04em", fontWeight: 600 }}>Eigenverbrauch</div>
            <div style={{ fontSize: v("--font-size-display-sm"), fontWeight: 800, fontFamily: v('--font-mono'), color: v('--color-accent'), marginTop: 4 }}>{Math.round(effEv)} %</div>
            <div style={{ fontSize: v("--font-size-caption"), color: v('--color-text-muted'), marginTop: 2 }}>deines Solarstroms nutzt du selbst</div>
          </div>
        </div>
        <div style={{ fontSize: v("--font-size-caption"), color: v('--color-text-muted'), marginTop: 10, lineHeight: 1.5, borderTop: `1px solid ${v('--color-border-muted')}`, paddingTop: 8 }}>
          ...
          <button
            ...
            style={{
              ...
              color: v('--color-accent'), fontWeight: 600, fontSize: v("--font-size-caption"), fontFamily: "inherit",
        ...
        return (
          <div style={{ background: v('--color-bg'), borderRadius: v('--radius-md'), padding: "12px 16px", marginBottom: 16, border: `1px solid ${v('--color-border')}` }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
              <span style={{ fontSize: v("--font-size-caption"), color: v('--color-text-secondary'), textTransform: "uppercase", letterSpacing: "0.04em", fontWeight: 600 }}>
            ...
            <div style={{ display: "flex", alignItems: "baseline", gap: 8, flexWrap: "wrap" }}>
              ...
              <div>
                <span style={{ fontSize: v("--font-size-caption"), color: v('--color-text-secondary') }}>Wärmepumpe: </span>
                <span style={{ fontSize: v("--font-size-lead"), fontWeight: 700, fontFamily: v('--font-mono'), color: v('--color-text-secondary') }}>
            ...
            <div style={{ fontSize: v("--font-size-caption"), color: v('--color-text-muted'), marginTop: 6, lineHeight: 1.5 }}>
