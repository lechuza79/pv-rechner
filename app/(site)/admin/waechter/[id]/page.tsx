...
export default async function WaechterReportPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div style={{ fontFamily: v("--font-text"), color: v("--color-text-primary"), maxWidth: 760 }}>
      <Link href="/admin/waechter" style={{ fontSize: 13, color: v("--color-accent"), textDecoration: "none" }}>← Alle Berichte</Link>

      <h1 style={{ fontSize: 22, fontWeight: 800, margin: `${space.md}px 0 ${space.xs}px` }}>{r.subject}</h1>
      <p style={{ fontSize: 12, color: v("--color-text-muted"), marginBottom: space.xl }}>
      ...
      {decisions.length > 0 && (
        <section style={{ marginBottom: space.xl }}>
          <h2 style={{ fontSize: 15, fontWeight: 700, marginBottom: space.sm }}>Deine Entscheidung</h2>
          <ol style={{ margin: 0, paddingLeft: space.lg, fontSize: 14, lineHeight: 1.7 }}>
      ...
      {done.length > 0 && (
        <section style={{ marginBottom: space.xl }}>
          <h2 style={{ fontSize: 15, fontWeight: 700, marginBottom: space.sm }}>Selbst erledigt</h2>
          <ul style={{ margin: 0, paddingLeft: space.lg, fontSize: 14, lineHeight: 1.7 }}>
      ...
      {r.details && (
        <section>
          <h2 style={{ fontSize: 15, fontWeight: 700, marginBottom: space.sm }}>Ganzer Lauf</h2>
          <pre style={{
            whiteSpace: "pre-wrap", wordBreak: "break-word",
            fontFamily: v("--font-mono"), fontSize: 12.5, lineHeight: 1.7,
