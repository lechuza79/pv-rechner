  ...
  return (
    <div style={{ background: v("--color-bg"), minHeight: "70vh", padding: "0 16px 40px", fontFamily: v("--font-text"), color: v("--color-text-primary") }}>
      <div style={{ maxWidth: 420, margin: "0 auto" }}>
        <h1 style={{ fontSize: v("--font-size-h1"), fontWeight: 800, letterSpacing: "-0.02em", marginBottom: 6 }}>Anmelden</h1>
        <p style={{ fontSize: v("--font-size-body"), color: v("--color-text-muted"), marginBottom: 20, lineHeight: 1.5 }}>
          Passwortlos per Magic Link: E-Mail eingeben, du bekommst einen Anmeldelink. Kein Passwort, keine Werbung.
        </p>

        {authState.status === "authed" ? (
          <div style={{ ...card, textAlign: "center" }}>
            <div style={{ fontSize: v("--font-size-body"), fontWeight: 700, marginBottom: 6 }}>Du bist bereits angemeldet.</div>
            <div style={{ fontSize: v("--font-size-small"), color: v("--color-text-secondary"), marginBottom: 16 }}>{authState.user.email}</div>
            <Link href={next} style={{ display: "inline-block", padding: "12px 24px", borderRadius: v("--radius-md"), fontSize: v("--font-size-body"), fontWeight: 700, background: v("--color-accent"), color: v("--color-text-on-accent"), textDecoration: "none" }}>
              Weiter →
            </Link>
          </div>
        ) : sent ? (
          <div style={{ ...card, textAlign: "center" }}>
            <div style={{ fontSize: v("--font-size-body"), fontWeight: 700, color: v("--color-accent"), marginBottom: 6 }}>Link gesendet!</div>
          ...
          <form onSubmit={handleSubmit} style={card}>
            <label htmlFor="login-email" style={{ display: "block", fontSize: v("--font-size-small"), fontWeight: 600, color: v("--color-text-secondary"), textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: 8 }}>
              E-Mail-Adresse
            </label>
            <input
              id="login-email"
              ...
              style={{
                width: "100%", padding: "12px 14px", borderRadius: v("--radius-md"), fontSize: v("--font-size-body"),
            ...
            <button
              ...
              disabled={busy}
              style={{
                width: "100%", padding: "13px", borderRadius: v("--radius-md"), fontSize: v("--font-size-body"), fontWeight: 700,
            ...
            {error && <div style={{ fontSize: v("--font-size-small"), color: v("--color-negative"), marginTop: 10 }}>{error}</div>}
          </form>
        )}
      </div>
    </div>
