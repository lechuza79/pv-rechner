...
await build({entryPoints:['public/hero-system/source/municipality.js','public/hero-system/source/hero-stage.js','public/hero-system/source/instances.js'],bundle:true,minify:true,format:'esm',splitting:true,outdir:'public/hero-system/dist',nodePaths:[upstream+'/node_modules'],plugins:[
