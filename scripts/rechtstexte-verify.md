...
- **Der Betreiber nimmt hier keine Fakten ab** (er ist kein Jurist). Ihm vorgelegt wird
  nur, was er allein weiß — z. B. **auf welchen Anbieter das Zielpostfach von
  `ADMIN_EMAILS` läuft**, weil davon abhängt, welcher Auftragsverarbeiter in Abschnitt 10
  zu nennen ist.

## Offene Punkte

- **OFFEN (bis 11/2026):** Empfänger des Kontaktformular-Postfachs in Abschnitt 10 nennen,
  sobald der Betreiber den Mailanbieter hinter `ADMIN_EMAILS` bestätigt hat.
